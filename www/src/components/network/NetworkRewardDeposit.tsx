    ...
    return (
        <div className={classes.root}>
            <div className={classes.reward}>
                <Amount amount={toNetworkDisplayValue(rewardValue, network.decimals)} currency={network.currency} label={t('idea.content.info.reward')} />
            </div>
            <div className={classes.deposit}>
                <Amount amount={toNetworkDisplayValue(resolvedBondValue, network.decimals)} currency={network.currency} label={t('idea.content.info.deposit')} />
            </div>
        </div>
    )
}
