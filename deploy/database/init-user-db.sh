...
GRANT ALL PRIVILEGES ON DATABASE "treasury_authorization_test" to authorization_manager;

EOSQL

for db_name in treasury treasury_test treasury_authorization treasury_authorization_test; do
