...
@Module({
    ...
    providers: [BlockchainService, BlockchainConfigurationService, BlockchainBountiesService],
    exports: [BlockchainService, BlockchainConfigurationService, BlockchainBountiesService],
})
